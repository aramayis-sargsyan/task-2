    ...
    return(
        <div className={"boardContainer"} >
            ...
            <div className={"boardButtonContainer"}>
                <Button style={{backgroundColor:"#9999ff",width:"50%",height:"40px"}} text={"board1"} handleOnClick={(e:any)=>openedItem(e)} value={"button1"}/>
            ...
            <div className={"boardItemContainer"} >
                ...
                <div className={"pageButton"}>
                    <Button style={{backgroundColor:"#9999ff",width:"104px",height:"40px"}} text={"board2 >"} handleOnClick={(e:any)=>openedItem(e)} value={"button2"}/>
                        <Link to={"/"}  >
                            <Button style={{backgroundColor:"#9999ff",width:"104px",height:"40px"}} text={"change"} handleOnClick={(e:any)=>changePage(e)} value={"button1"}/>
                        </Link>
                </div>
            </div>
            }
